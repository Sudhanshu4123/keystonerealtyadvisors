...
export const metadata = {
  ...
  description: 'Learn about Keystone Real Estate - premier property developer, mission, vision, leadership team, and track record.',
};
...
export default function AboutPage() {
  ...
  return (
    <div className="pt-28 pb-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-20 bg-white">
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-3xl p-10 shadow-2xl">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          <div className="space-y-1">
            <span className="text-4xl font-black text-amber-400">48+</span>
            <p className="text-xs uppercase tracking-widest text-slate-300 font-bold">Projects Delivered</p>
          </div>
          <div className="space-y-1">
      ...
      <div className="space-y-10">
        <div className="text-center max-w-2xl mx-auto space-y-2">
          <span className="text-amber-600 font-bold text-xs uppercase tracking-widest">Leadership</span>
          <h2 className="text-3xl font-extrabold text-slate-900">Meet Our Executive Advisory Team</h2>
          <p className="text-slate-600 text-sm">Decades of combined expertise in real estate brokerage, financial modeling, and asset management.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {team.map((member) => (
            <div
              key={member.name}
              className="bg-white border border-slate-200 rounded-3xl overflow-hidden shadow-xl space-y-4 p-5 group"
            >
              ...
              <div className="space-y-1.5">
                ...
                <span className="text-xs font-semibold text-amber-600 block">{member.role}</span>
      ...
      {/* CTA */}
      <div className="text-center bg-slate-900 border border-slate-800 rounded-3xl p-10 space-y-6 text-white">
        <h2 className="text-3xl font-extrabold">Experience The Keystone Difference</h2>
