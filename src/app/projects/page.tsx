  ...
  const fetchProjects = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setPagination(data.pagination || { total: 0, totalPages: 1, limit: 12 });
      }
    } catch (err) {
        ...
        <main className="lg:col-span-3 space-y-8">
          ...
          <div className="flex items-center justify-between text-xs text-slate-600 font-medium">
            <span>
              ...
              <strong className="text-slate-900">{pagination.total}</strong> projects
            </span>
          </div>
          ...
          {pagination.totalPages > 1 && (
            <div className="flex items-center justify-center gap-2 pt-6">
              <button
                ...
                className="p-2.5 rounded-xl bg-white border border-slate-200 text-slate-700 hover:text-slate-900 disabled:opacity-40 cursor-pointer shadow-sm"
              >
